...
<section id="container" >
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active" ><a  href="basicInfo/juanShe">圈舍设置</a></li>
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> 圈舍设置</h3>
            <div class="row">
                <div class="col-md-12">
                    <div class="content-panel">
                        <h4>
                            <i class="fa fa-angle-right"></i> 种猪圈舍设置
                ...
                <div class="col-md-12">
                    <div class="content-panel">
                        <h4>
                            <i class="fa fa-angle-right"></i> 商品猪圈舍设置
                            <button type="button" class="btn btn-info add">添加</button>
                        </h4>
                        <hr>
                        <table class="table">
    ...
    <footer class="site-footer">
        <div class="text-center">
            2018届信息管理与信息系统一班马金金
            <a href="juanShe.php#" class="go-top">
